...
export const createActionSetToDo = function (toDo: Array<usersToDo | usersData>): {
  type: string
...
export const createActionSetInProgress = function (inProgress: Array<usersToDo>): {
  type: string
...
export const createActionSetUser = function (user: Array<usersData | usersToDo>): {
  type: string
